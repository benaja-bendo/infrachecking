...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>@yield('title') | InfraChecking</title>
    ...
    <div class="container" data-layout="container">
            ...
            <div class="d-flex align-items-center">
                ...
                <a class="navbar-brand" href="/">
                    <div class="d-flex align-items-center py-3">
                        ...
                        {{--                             width="40"/>--}}
                        <span class="font-sans-serif">InfraCheck</span></div>
                </a>
            </div>
        ...
        <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-xl"
            ...
            <a class="navbar-brand mr-1 mr-sm-3" href="index.html">
                <div class="d-flex align-items-center"><img class="mr-2" src="assets/img/illustrations/falcon.png"
                                                            alt="" width="40"/><span
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand"
                ...
                <a class="navbar-brand mr-1 mr-sm-3" href="index.html">
                    <div class="d-flex align-items-center"><img class="mr-2" src="assets/img/illustrations/falcon.png"
                                                                alt="" width="40"/><span
                            class="font-sans-serif">Infrackeck</span></div>
                </a>
